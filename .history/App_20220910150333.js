...
const playMatch = () => {
  ...
  const playerSelection = document.querySelector(".player-hand");
  ...
  options.forEach(option => {
    option.addEventListener("click", function() {
      ...
      setTimeout(() => {
        ...
        //Update Images
        playerSelection.src = `./images/${this.textContent}.png`;
        computerHand.src = `./images/${computerSelection}.png`;
      }, 2000);
      //Animation
      playerSelection.style.animation = "shakePlayer 2s ease";
